...
from .serializers import RegistrationSerializer, CustomAuthTokenSerializer, CustomObtainTokenPairSerializer, ChangePasswordApiView, ProfileSerializer, ActivationResendSerializer
...
class ActivationApiView(APIView):
    ...
    def get(self, request, token, *args, **kwargs):
        ...
        if user_obj.is_verified:
            return Response({'details':'your account has been already been verified'})
        user_obj.is_verified = True
        user_obj.save()
        return Response({'details':'your account have been verified and activated successfuly'})
